...
#filter by rows and columns (all below do the same thing )
...
#filtering data by columns & boolean indexing (all below do the same thing )
data[(data['age'] < 5)]
data.loc[(data.age <5),:]
...
#conditional operator with lambda function
